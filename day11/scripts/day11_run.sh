...
# ---------------------------
# Day 11 Runner (Probe_B Micro-Attribution: Decomposition Ladder + R2 Telemetry)
# Cycle: B -> I -> R1 -> R2(probes by MODE + PROBE_ACTIONS, telemetry) -> B2
# Writes logs to ../runs/<timestamp>_day11_offX_<MODE>_actions<PROBE_ACTIONS>_bvar<PROBE_B_VARIANT>_nY/
# ---------------------------
...
RUN_NAME="${TS}_day11_off${OFF_SEC}_${MODE}_actions${PROBE_ACTIONS}_bvar${PROBE_B_VARIANT}_n${N_CYCLES}"
