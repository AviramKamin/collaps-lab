...
TARGET="${TARGET:-$HOME/project/day23/workdir/retry_test}"
...
while true; do
  for i in $(seq 1 10); do
    ...
    # Buffered mode preserves the Day21/Day22 active path.
    # Direct mode remains available for future reuse if needed.
