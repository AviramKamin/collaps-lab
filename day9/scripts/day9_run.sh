...
# Probes
ENABLE_PROBES="${ENABLE_PROBES:-1}"     # overridden by MODE
...
# Background IO
ENABLE_BGIO="${ENABLE_BGIO:-0}"                 # overridden by MODE
...
# microSD-safe: no sync here (avoid leaking writeback into B2)
probe_action_B() {
